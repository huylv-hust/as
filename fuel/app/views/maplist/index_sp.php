...
<style>
 ...
 <div id="mainarea">
	<h3 class="tit"><span><?php echo \Constants::$pit_work[\Fuel\Core\Uri::segment(1)] ?>のご予約</span></h3>
		...
		<?php
			foreach($array_ss as $row)
			{
				echo '<li style="height:165px">
					...
					<div class="pd10">
						<a class="grebt" href="'.\Fuel\Core\Uri::base().\Fuel\Core\Uri::segment(1).'/reserve/?sscode='.$row['sscode'].'">このSSで予約する</a>
					</div>
				</li>';
			}
		?>
