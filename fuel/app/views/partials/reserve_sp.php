...
?>
	...
	<div class="pd10">
		<?php 
			if(\Cookie::get('back_url'))
			{	
				$href =	\Cookie::get('back_url');
			}
			else
			{
				$href = \Uri::base().Uri::segment('1').'/search';
			}
		?>
		<a href="<?php echo $href; ?>" class="graybt">戻る</a>
	</div>
