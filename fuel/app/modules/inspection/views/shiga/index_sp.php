  <script>        
// shaken price　shiga (4)

   $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p4 #select_1,#ins_p4 .c_1').serializeArray();
   		$('#ins_p4 #results_1').empty();
   		var sum = 57830;
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p4 #results_1').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p4 #results_1').text(sum);
        }
    }
 
    $(".c_1:checkbox").click(countUpDown);
    $("#ins_p4 #select_1").change(countUpDown);
    countUpDown();
     ...
     $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p4 #select_2,#ins_p4 .c_2').serializeArray();
   		$('#ins_p4 #results_2').empty();
   		var sum = 69100;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p4 #results_2').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p4 #results_2').text(sum);
        }
    }
 
    $(".c_2:checkbox").click(countUpDown);
    $("#ins_p4 #select_2").change(countUpDown);
    countUpDown();
       ...
       $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p4 #select_3,#ins_p4 .c_3').serializeArray();
   		$('#ins_p4 #results_3').empty();
   		var sum = 77300;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p4 #results_3').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p4 #results_3').text(sum);
        }
    }
 
    $(".c_3:checkbox").click(countUpDown);
    $("#ins_p4 #select_3").change(countUpDown);
    countUpDown();
       ...
       $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p4 #select_4,#ins_p4 .c_4').serializeArray();
   		$('#ins_p4 #results_4').empty();
   		var sum = 85500;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p4 #results_4').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p4 #results_4').text(sum);
        }
    }
 
    $(".c_4:checkbox").click(countUpDown);
    $("#ins_p4 #select_4").change(countUpDown);
    countUpDown();
	...
	<div id="mainarea">
		...
		<div id="inspection">
        <h2 class="btit">滋賀（８号栗東）の料金表</h2>
			<p class="sub">車検のご予約は満了日の6ヶ月前から承ります。最大8,000円の割引！<br />
		  ...
		  <form id="ins_p4">
              ...
              <div class="pd10">
              <a class="grebt" href="<?php echo Uri::base() ?>inspection/maplist?sscode=249733">この店舗でご予約</a>
              </div>
