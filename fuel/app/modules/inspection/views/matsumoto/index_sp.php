 ...
 // shaken price　matsumoto (3)
   ...
   $(function(){
	...
	<div id="mainarea">
		...
		<div id="inspection">
        <h2 class="btit">松本（１９号塩尻北インター）の料金表</h2>
			<p class="sub">車検のご予約は満了日の6ヶ月前から承ります。最大7,000円の割引！<br />
		  ...
		  <form id="ins_p3">
              ...
              <div class="pd10">
              <a class="grebt" href="<?php echo Uri::base() ?>inspection/maplist?sscode=280715">この店舗でご予約</a>
              </div>
