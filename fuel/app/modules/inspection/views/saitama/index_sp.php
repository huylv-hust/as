  <script>        
// shaken price　saitama (10)

   $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p10 #select_1,#ins_p10 .c_1').serializeArray();
   		$('#ins_p10 #results_1').empty();
   		var sum = 62070;
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p10 #results_1').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p10 #results_1').text(sum);
        }
    }
 
    $(".c_1:checkbox").click(countUpDown);
    $("#ins_p10 #select_1").change(countUpDown);
    countUpDown();
     ...
     $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p10 #select_2,#ins_p10 .c_2').serializeArray();
   		$('#ins_p10 #results_2').empty();
   		var sum = 73340;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p10 #results_2').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p10 #results_2').text(sum);
        }
    }
 
    $(".c_2:checkbox").click(countUpDown);
    $("#ins_p10 #select_2").change(countUpDown);
    countUpDown();
       ...
       $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p10 #select_3,#ins_p10 .c_3').serializeArray();
   		$('#ins_p10 #results_3').empty();
   		var sum = 81540;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p10 #results_3').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p10 #results_3').text(sum);
        }
    }
 
    $(".c_3:checkbox").click(countUpDown);
    $("#ins_p10 #select_3").change(countUpDown);
    countUpDown();
       ...
       $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p10 #select_4,#ins_p10 .c_4').serializeArray();
   		$('#ins_p10 #results_4').empty();
   		var sum = 89740;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p10 #results_4').text());
    	var sum = sumNumbers ();
    	{
        	$('#ins_p10 #results_4').text(sum);
        }
    }
 
    $(".c_4:checkbox").click(countUpDown);
    $("#ins_p10 #select_4").change(countUpDown);
    countUpDown();
       ...
       $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p10 #select_5,#ins_p10 .c_5').serializeArray();
   		$('#ins_p10 #results_5').empty();
   		var sum = 97940;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p10 #results_5').text());
    	var sum = sumNumbers ();
         {
        	$('#ins_p10 #results_5').text(sum);
        }
    }
 
    $(".c_5:checkbox").click(countUpDown);
    $("#ins_p10 #select_5").change(countUpDown);
    countUpDown();
       ...
       $(function(){
   	function sumNumbers() {
   		var fields = $('#ins_p10 #select_6,#ins_p10 .c_6').serializeArray();
   		$('#ins_p10 #results_6').empty();
   		var sum = 52970;
   		$.each(fields, function(i, field){
   			sum += parseInt(field.value);
   		});
    ...
    function countUpDown() {
    	var n = parseInt($('#ins_p10 #results_6').text());
    	var sum = sumNumbers ();
         {
        	$('#ins_p10 #results_6').text(sum);
        }
    }
 
    $(".c_6:checkbox").click(countUpDown);
    $("#ins_p10 #select_6").change(countUpDown);
    countUpDown();
	...
	<div id="mainarea">
		...
		<div id="inspection">
        <h2 class="btit">さいたま鴻巣（１７号鴻巣）の料金表</h2>
			...
			<form id="ins_p10">
                ...
                <tr>
                    <td class="bg1">合計</td>
                    <td class="bg2"><strong>¥62,070</strong></td>
                  </tr>
                <tr>
                ...
                <tr>
                    <td class="bg1">合計</td>
                    <td class="bg3"><strong>¥73,340</strong></td>
                  </tr>
                <tr>
                    <td class="bg1">早期予約割引</td>
                    <td class="bg3">
                ...
                <tr>
                    <td class="bg1">合計</td>
                    <td class="bg4"><strong>¥81,540</strong></td>
                  </tr>
                <tr>
                    <td class="bg1">早期予約割引</td>
                    <td class="bg4">
                ...
                <tr>
                    <td class="bg1">合計</td>
                    <td class="bg5"><strong>¥89,740</strong></td>
                  </tr>
                <tr>
                    <td class="bg1">早期予約割引</td>
                    <td class="bg5">
                ...
                <tr>
                    <td class="bg1">合計</td>
                    <td class="bg6"><strong>¥97,940</strong></td>
                  </tr>
                <tr>
                    <td class="bg1">早期予約割引</td>
                    <td class="bg6">
                ...
                <tr>
                    <td class="bg1">合計</td>
                    <td class="bg7"><strong>¥52,970</strong></td>
                </tr>
                <tr>
                    <td class="bg1">早期予約割引</td>
                    <td class="bg7">
              ...
              <div class="pd10">
              <a class="grebt" href="<?php echo Uri::base() ?>inspection/maplist?sscode=264341">この店舗でご予約</a>
              </div>
