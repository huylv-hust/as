...
<p class="message"style="font-size:16px; font-weight:bold;">※車検工場へ直接来店される方のみWEB予約が可能です。</p>

<?php
if ($ss_info[0]['sscode'] == '330840' or $ss_info[0]['sscode'] == '249733' ){
	echo '<p class="message">※当SSは認証工場の為、土日祝の受付及び整備は行なえますが、『検査（車検）』に関しては平日のみ実施となりますので、土日祝にご予約を希望されるお客様は店舗にご確認下さい。<br />尚、『1日車検』『55分車検』に於きましても実施しておりません。ご予約は検査日の一週間前までの受付とさせて頂きます。</p>';
	}
?>
...
<div id="sslist">
	<ul>
		<li>
			...
			<a class="btrese" href="<?php echo \Uri::base().'inspection/reserve?sscode='.$ss_info[0]['sscode']; ?>">このSSで予約する</a>
		</li>
	</ul>
</div>

<h4 class="subtit" style="margin-top:60px;">車検受付店舗一覧</h4>

<p class="message" style="font-size:16px; font-weight:bold;">※下記SSでWEB予約は行なえません。詳しくは各SSへお問い合わせ下さい。</p>
