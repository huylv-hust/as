   ...
   $(function(){
	...
	<h3 class="tit">車検の料金</h3>
                ...
                <div id="inspection">
                 ...
                 <div id="price_7">
                <div id="price_a">
               <h1>仙台（４号仙台泉インターシティ）の料金表</h1>
               <p>車検のご予約は満了日の6ヶ月前から承ります。最大10,000円の割引！<br />
                ...
                <p class="cap">※価格は税込みです。<br />
                 ...
                 <div id="btac">
                  <a class="m_btg" href="<?php echo Uri::base() ?>inspection/maplist?sscode=332152">「４号仙台泉インターシティ」店でご予約</a>
                 </div>　　　　　　
